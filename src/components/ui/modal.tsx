 ...
 * trap, body-scroll-lock, and focus restore. Pass `onSubmit` to wrap the body+footer in a <form>
 * so a footer submit button works.
 */
export function Modal({
  ...
  const inner = (
    <>
      <div className="min-h-0 flex-1 space-y-4 overflow-y-auto px-5 py-1">{children}</div>
      {footer && (
